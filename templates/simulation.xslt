...
void initialise(char * inputfile){
	...
	// Jenny changed: int to size_t because high buffersizes caused here an overflow
	size_t xmachine_<xsl:value-of select="xmml:name"/>_SoA_size = sizeof(xmachine_memory_<xsl:value-of select="xmml:name"/>_list);<xsl:for-each select="xmml:states/gpu:state">
	...
	// Jenny changed: int to size_t because high buffersizes caused here an overflow
	size_t message_<xsl:value-of select="xmml:name"/>_SoA_size = sizeof(xmachine_message_<xsl:value-of select="xmml:name"/>_list);
